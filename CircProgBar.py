...
class RadialProgressbar(tk.Frame):
    ...
    def __init__(self, parent, size=2000, bg=None, fg='cyan', text_fg=None, text_bg=None, font=None, font_size_ratio=0.1,
        ...
        self.bar = ttk.Progressbar(self, orient='horizontal', mode='determinate', length=self.size[0],
                                   variable=self.var, style=self.bar_style, maximum = 2000)
        self.bar.pack()

        # percentage Label
        self.percent_label = ttk.Label(self.bar, text='0 W')
    ...
    def show_percentage(self, *args):
        ...
        bar_value = self.get()
        self.percent_label.config(text=f'{bar_value} W')
